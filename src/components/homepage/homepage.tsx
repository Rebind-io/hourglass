...
export default function HomepageMain() {
  ...
  return (
    <div className='min-h-[calc(100vh-3.5rem)] bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4 transition-colors duration-300'>
      <Card className='w-full max-w-md shadow-2xl border border-border/50 bg-card/80 backdrop-blur-sm'>
